...
function seed() {
  ...
  if (data.categories.length === 0) {
    ...
    const items = [
      ...
      { id: 3, category_id: 2, name: 'French Fries', description: 'Crispy golden fries', price: 3.0, image_url: 'https://picsum.photos/id/1013/900/540', video_url: '', nutrition: 'Proteins: 3g, Carbs: 40g, Fats: 15g', ingredients: 'Potatoes, Oil, Salt', allergies: 'None', prep_time: '5 min', hidden: 0, sort_order: 1 },
      { id: 4, category_id: 3, name: 'Cola', description: 'Chilled refreshing drink', price: 2.0, image_url: 'https://picsum.photos/id/1014/900/540', video_url: '', nutrition: 'Proteins: 0g, Carbs: 40g, Fats: 0g', ingredients: 'Water, Sugar, Flavorings', allergies: 'None', prep_time: '1 min', hidden: 0, sort_order: 1 }
    ];
...
// CLI usage: node src/db-simple.js --reset
